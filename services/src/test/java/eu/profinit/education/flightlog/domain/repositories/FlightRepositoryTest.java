...
public class FlightRepositoryTest {
    ...
    public void shouldLoadGliderFlights() {
        //  2.2: Zmente volanou testovaci metodu, aby vratila vsechny lety kluzaku a smažte anotaci @Ignore
    ...
    public void shouldLoadFlightsInTheAir() {
        //  2.4: Doplňte název testované metody a smažte anotaci @Ignore
